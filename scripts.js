//need to stop computer placing a move if the human player has won
//need to properly reset ai vs player game
//need AI to play move on each subsequent game if player 1 is O (separate ai reset?)
//need to change ai for minmax algorithm
//need to stop player being able to make moves in pause before computer makes a move
    ...
    $("svg").click(function () {
      ...
      if ($("#game").attr("class") == "humans") {
        if ($(this).hasClass("unplayed")) {
          ...
          if (count % 2 != 0) {
            ...
            //$("#turnIndicatorP2").css("visibility", "visible");
            //$("#turnIndicatorP1").css("visibility", "hidden")
            //checks if clicks count is even, and sets symbol to O
          } else if (count % 2 == 0) {
            $(this).addClass("O");
            $(this).html(pathO);
            $(".turnIndicator").toggleClass("visible invisible");
            //$("#turnIndicatorP1").css("visibility", "visible");
            //$("#turnIndicatorP2").css("visibility", "hidden");
          }
      ...
      if ($("#game").attr("class") == "ai") {
        ...
        if ($(this).hasClass("unplayed") && count >= 0) {
          ...
          else if (count % 2 == 0) {//same as P1 = "O"
            $(this).addClass("O");
            $(this).html(pathO);
            $(".turnIndicator").toggleClass("visible invisible");
            //$("#turnIndicatorP1").css("visibility", "visible");
